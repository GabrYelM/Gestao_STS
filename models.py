...
class REL01(db.Model):
    __tablename__ = 'REL-01'
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    tipo = db.Column(db.String(50), nullable=False, index=True)
    cnes = db.Column(db.String(50), nullable=True)
    estabelecimento = db.Column(db.String(255), nullable=True, index=True)
    da = db.Column(db.String(100), nullable=True)
    populacao_total = db.Column(db.Float, default=0.0)
    faixa_00_04 = db.Column(db.Float, default=0.0)
    faixa_05_09 = db.Column(db.Float, default=0.0)
    faixa_10_14 = db.Column(db.Float, default=0.0)
    faixa_15_19 = db.Column(db.Float, default=0.0)
    faixa_20_24 = db.Column(db.Float, default=0.0)
    faixa_25_29 = db.Column(db.Float, default=0.0)
    faixa_30_34 = db.Column(db.Float, default=0.0)
    faixa_35_39 = db.Column(db.Float, default=0.0)
    faixa_40_44 = db.Column(db.Float, default=0.0)
    faixa_45_49 = db.Column(db.Float, default=0.0)
    faixa_50_54 = db.Column(db.Float, default=0.0)
    faixa_55_59 = db.Column(db.Float, default=0.0)
    faixa_60_64 = db.Column(db.Float, default=0.0)
    faixa_65_69 = db.Column(db.Float, default=0.0)
